...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        [self setTitleColor:grayBlueC forState:UIControlStateNormal];
        [self setTitleColor:grayBlueC forState:UIControlStateSelected];
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect
{
    ...
    CGFloat imageX  = self.bounds.size.width*0.3;
