...
//  QiPinTong
//
//  Created by 企聘通 on 2017/5/25.
//  Copyright © 2017年 ShiJiJiaLian. All rights reserved.
//

#import "QPTFMDB.h"

#define SQLITE_NAME @"QPTSqlite.sqlite"
...
static QPTFMDB *QPTFmdb;

@implementation QPTFMDB
...
-(BOOL)createTableWithTableName:(NSString *)name keys:(NSArray *)keys
{
    ...
    [self.queue inDatabase:^(FMDatabase *db) {
        ...
        NSString *header = [NSString stringWithFormat:@"create table if not exist %@ (id integer primary key autoincrement)",name];
