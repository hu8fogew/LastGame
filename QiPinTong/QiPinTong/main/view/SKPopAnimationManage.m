...
- (void)animationDirectionInitialize
{
    if (_animationDirection == SK_ANIMATION_SUBTYPE_FROMRIGHT) {
        _animationView.center = CGPointMake(SCREEN_WIDTH + 1000, WindowCenter.y);
        
    } else if (_animationDirection == SK_ANIMATION_SUBTYPE_FROMLEFT) {
        _animationView.center = CGPointMake(SCREEN_WIDTH - 1000, WindowCenter.y);
        
    } else if (_animationDirection == SK_ANIMATION_SUBTYPE_FROMTOP) {
        _animationView.center = CGPointMake(WindowCenter.x, SCREEN_HEIGHT - 1000);
...
- (CABasicAnimation *)transformationAnimationGroup
{
    ...
    boundsAnimation.toValue = [NSValue valueWithCGRect:CGRectMake(_animationView.bounds.origin.x, _animationView.bounds.origin.y, SCREEN_WIDTH - 120, 180)];
