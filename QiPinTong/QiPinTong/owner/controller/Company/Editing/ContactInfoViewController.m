...
//  QiPinTong
//
//  Created by taylor on 2017/4/10.
//  Copyright © 2017年 ShiJiJiaLian. All rights reserved.
//

#import "ContactInfoViewController.h"

@interface ContactInfoViewController ()<UITableViewDelegate,UITableViewDataSource,EditingControllerBackStringDelegate>
...
- (void)viewDidLoad {
    ...
    self.titleAry = [NSMutableArray arrayWithObjects:@"联系人",@"联系人职务",@"联系电话",@"   企业官网",@"企业地址",@"",@"",nil];
    
    self.sLabelAry = [NSMutableArray arrayWithObjects:@"请填写",@"请填写",@"请填写",@"请填写",@"请选择",@"请填写详细地址",@"", nil];
}
